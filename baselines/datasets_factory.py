...
class DatasetsFactory(object):
    ...
    @staticmethod
    def get_inference_dataset(model_name: str, samples_dir: str, labels_dir: str, num_frames: int) -> CaterAbstractDataset:
        ...
        if model_name in TRAINING_SUPPORTED_MODELS_6_TRACKS:
			#AT: It uses this one!
            return Cater6TracksForObjectsInferenceDataset(samples_dir, labels_dir, num_frames)
